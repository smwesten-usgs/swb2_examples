...
SOIL_GROUP ARC_GRID input/hydrologic_soils_group.asc
...
WATER_CAPACITY ARC_GRID input/available_water_capacity.asc
WATER_CAPACITY_PROJECTION_DEFINITION +proj=tmerc +lat_0=0.0 +lon_0=-90.0 +k=0.9996 +x_0=520000 +y_0=-4480000 +datum=NAD83 +units=m

IRRIGATED_LAND_MASK ARC_GRID input/irrigation_mask_from_cdl.asc
...
DUMP_VARIABLES COORDINATES 552893. 445565.
